...
REM
REM Windows-native install isn't supported — Docker Desktop requires WSL2
REM as its backend on Windows anyway.
...
echo.
echo  Setup script finished. Open Docker Desktop, then browse to:
